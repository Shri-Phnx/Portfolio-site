            ...
            {experience.map((stop, idx) => (
              ...
              >
                ...
                <div className="ml-14 md:ml-12 pl-2">
                  ...
                  <h3
                    className="text-2xl sm:text-3xl lg:text-4xl tracking-wide text-white group-hover:text-[#F7E7C4] transition-colors mb-1 leading-[0.95]"
                    style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                  >
                    {stop.title}
                  </h3>
                  ...
                  {stop.points.length > 0 && (
                    ...
                    >
                      {stop.points.map((point) => (
                        <li
                          key={point}
                          className="relative pl-4 text-xs sm:text-[13px] font-light text-[#A8988B] leading-[1.7] group-hover:text-[#D5CBC0] transition-colors"
                        >
                          <span className="absolute left-0 top-[0.6em] w-1.5 h-[1px] bg-[#D4AF37]/70" />
                          {point}
                        </li>
                      ))}
                    </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {education.map((item) => (
              ...
              >
                ...
                <h3
                  className="text-2xl tracking-wide text-white leading-tight mb-2"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  {item.title}
                </h3>
